        ...
        child: Column(
          children: [
            ...
            _buildDetailTile(
              Icons.settings,
              'Payout Settings',
              'Weekly settlements (Every Monday)',
            ),
          ],
        ),
      ),
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text(
                      isOnline ? 'You are visible to orders' : 'You are offline',
                      style: TextStyle(
      ...
      children: [
        ...
        SizedBox(
          ...
          child: OutlinedButton(
            ...
            child: Text(btnText, style: TextStyle(color: color)),
          ),
        ),
      ],
    ),
